...
- Use a verb for an action, not a noun derived from that verb.
- Avoid phrasal verbs (verb plus particle). Their meaning is not predictable from the parts, and non-native readers and translation systems both mishandle them.
...
- Semicolons are not permitted as a way to join clauses; write separate sentences.
